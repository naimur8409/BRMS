...
<!-- ================================Admin======================== -->
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="result_list.php">Result List</a>
                                    <a class="nav-link" href="addBacklog.php">Add backlog</a>
                                    <a class="nav-link" href="backlogList.php">Backlog List</a>
                                </nav>
                            </div>
                    </div>
