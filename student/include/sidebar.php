...
<!-- ================================Admin======================== -->
                            ...
                            <div class="collapse" id="collapsePages2" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="../admin/add_admin.php">Add Admin</a>
                                    <a class="nav-link" href="../admin/admin_list.php">Admin List</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth"
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="CSE.php?dept=CSE">Student of CSE</a>
                                            <a class="nav-link" href="EEE.php?dept=EEE">Student of EEE</a>
                                            <a class="nav-link" href="CE.php?dept=CE">Student of CE</a>
                                            <a class="nav-link" href="DBA.php?dept=DBA">Student of DBA</a>
                                            <a class="nav-link" href="ENG.php?dept=ENG">Student of ENG</a>
                                            <a class="nav-link" href="LAW.php?dept=LAW">Student of LAW</a>
                                        </nav>
                                    </div>
